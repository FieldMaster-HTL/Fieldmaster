...
describe('Tasks page (FMST-35, FMST-11, FMST-50)', () => {
  ...
  it('calls createTaskAction with area when submitting form with area selected', async () => {
    ...
    await waitFor(() => {
      expect(createTaskAction).toHaveBeenCalledWith('Test Task', 'Beschreibung', 'creator-1', undefined)
    })
  })
  ...
  it('displays area name in task list when task has area', async () => {
    ...
    const mockTasks = [
      { id: 'task-1', name: 'Task 1', description: '', createdAt: new Date(), dueTo: undefined, areaId: 'area-1', creatorClerkId: 'user-1' },
    ]
  ...
  it('displays area name in modal when task is clicked', async () => {
    ...
    const mockTasks = [
      { id: 'task-1', name: 'Task 1', description: 'Desc', createdAt: new Date(), dueTo: undefined, areaId: 'area-1', creatorClerkId: 'user-1' },
    ]
  ...
  it('displays "Unbekannt" in modal when area is not found', async () => {
    const mockTasks = [
      { id: 'task-1', name: 'Task 1', description: 'Desc', createdAt: new Date(), dueTo: undefined, areaId: 'unknown-area', creatorClerkId: 'user-1' },
    ]
  ...
  it('displays delete button on task item', async () => {
    const mockTasks = [
      { id: 'task-1', name: 'Task 1', description: '', createdAt: new Date(), dueTo: undefined, areaId: undefined, creatorClerkId: 'user-1' },
    ]
  ...
  it('clears form after successful task creation', async () => {
    ...
    const descInput = screen.getByPlaceholderText('Beschreibung (optional)...') as HTMLTextAreaElement
    const button = screen.getByRole('button', { name: /hinzufügen/i })
